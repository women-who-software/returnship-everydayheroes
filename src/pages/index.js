    ...
    <div>
        <Layout>
          ...
          <p> Hello! We're creating a podcast that features Everyday Heroes who are willing to tell 
              ...
              <form name="share-your-story" method="post" data-netlify="true" data-netlify-honeypot="bot-field">
                ...
                <input type="hidden" name="form-name" value="share-your-story" />
                  ...
                  <div className="field half">
                    ...
                    <input type="text" name="email" id="email" placeholder="janesmith@email.com" />
                  </div>

                  <div className="field location">
                    <label htmlFor="email">Location</label>
                    <input type="text" name="location" id="location" placeholder =" Denver, CO" />
                  </div>

                  <div className="field phone">
                    <label htmlFor="email">Phone Number </label>
                    <input type="text" name="phone" id="phone" placeholder="123 456 5555"/>
                  </div>
                  ...
                  <div className="field">
                    ...
                    <textarea name="story" id="story" rows="6" placeholder="My story..."/>
                  </div>
